...
export const defaultTransactions: Transaction[] = [
  { id: '20260318-0001', date: new Date(Date.now() - 13 * 60000).toISOString(), cashier: 'Store Owner', items: [{ name: 'Coca Cola 350ml', qty: 12, type: 'ws', price: 240 }], total: 2880, rawTotal: 2880, discount: 0, type: 'ws', status: 'completed', amountTendered: 3000, change: 120, paymentMethod: 'cash', taxAmount: 0 },
  { id: '20260318-0002', date: new Date(Date.now() - 13 * 60000).toISOString(), cashier: 'Store Owner', items: [{ name: 'Lucky Me Pancit Canton', qty: 25, type: 'ws', price: 12 }], total: 6000, rawTotal: 6000, discount: 0, type: 'ws', status: 'completed', amountTendered: 6000, change: 0, paymentMethod: 'gcash', paymentRef: 'DEMO-0002', taxAmount: 0 },
  { id: '20260318-0003', date: new Date(Date.now() - 7 * 60000).toISOString(), cashier: 'Store Owner', items: [{ name: 'Pringles Original', qty: 2, type: 'rt', price: 85 }, { name: 'Coca Cola 350ml', qty: 97, type: 'ws', price: 42 }], total: 4162, rawTotal: 4162, discount: 0, type: 'mixed', status: 'completed', amountTendered: 4200, change: 38, paymentMethod: 'cash', taxAmount: 0 },
  { id: '20260318-0004', date: new Date(Date.now() - 6 * 60000).toISOString(), cashier: 'Store Owner', items: [{ name: 'Nestle Coffee 3-in-1', qty: 1, type: 'rt', price: 8.5 }], total: 8.5, rawTotal: 8.5, discount: 0, type: 'rt', status: 'completed', amountTendered: 10, change: 1.5, paymentMethod: 'maya', paymentRef: 'DEMO-0004', taxAmount: 0 },
  { id: '20260318-0005', date: new Date(Date.now() - 1 * 60000).toISOString(), cashier: 'Store Staff', items: [{ name: 'Coca Cola 350ml', qty: 1, type: 'ws', price: 240 }], total: 240, rawTotal: 240, discount: 0, type: 'ws', status: 'completed', amountTendered: 250, change: 10, paymentMethod: 'cash', taxAmount: 0 },
];
